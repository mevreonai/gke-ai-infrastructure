...
.PARAMETER ClusterName
    Optional specific cluster name to delete (e.g. "vllm-singlehost-cluster" or "ray-llm-cluster").
...
.EXAMPLE
    .\cleanup.ps1
    .\cleanup.ps1 -ClusterName "vllm-singlehost-cluster" -Region "europe-west4"
#>
